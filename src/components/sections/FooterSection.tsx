...
export default function FooterSection() {
  return (
    <footer className="bg-navy-950 text-cream-50 pt-16 pb-12 px-4 sm:px-6 lg:px-12 border-t-2 border-gold/40">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8 pb-14 border-b border-gold/20">
          ...
          <div className="lg:col-span-4 space-y-4">
            ...
            <p className="text-xs sm:text-sm text-cream-100/75 leading-relaxed">
              Crafted with authentic tradition in Raniganj, West Bengal by R.R. Food Products.
          ...
          <div className="lg:col-span-2 space-y-3">
            ...
            <ul className="space-y-2 text-xs text-cream-100/80">
              <li>
                <Link href="#hero" className="hover:text-gold transition-colors">
                  Flagship Stage
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="#why-taja" className="hover:text-gold transition-colors">
                  Why Taja
                </Link>
              </li>
              <li>
                <Link href="#ingredients" className="hover:text-gold transition-colors">
                  Authentic Ingredients
                </Link>
              </li>
              <li>
                <Link href="#shelf" className="hover:text-gold transition-colors">
                  The Complete Shelf
                </Link>
              </li>
              <li>
          ...
          <div className="lg:col-span-3 space-y-3">
            ...
            <div className="p-3.5 rounded-xl bg-navy-900 border border-gold/40 space-y-2">
              ...
              <p className="text-[11px] font-mono text-gold bg-navy-950 px-2 py-1 rounded border border-gold/20">
            ...
            <div className="pt-2 flex items-center gap-3">
              ...
              <Link
                ...
                target="_blank"
                className="p-1.5 rounded-full bg-navy-900 border border-gold/30 text-gold hover:bg-gold hover:text-navy-950 transition-colors"
